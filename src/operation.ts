...
export interface OperationObject extends Extendable {
   ...
   * is already defined at the [Path
   * Item](https://spec.openapis.org/oas/latest.html#pathItemParameters), the
   * new definition will override it but can never remove it. The list _MUST
   * NOT_ include duplicated parameters. A unique parameter is defined by a
   * combination of a
   ...
   * \[[RFC7231](https://spec.openapis.org/oas/latest.html#bib-RFC7231)\] has
   ...
   * [DELETE](https://tools.ietf.org/html/rfc7231#section-4.3.5)), `requestBody`
   * is permitted but does not have well-defined semantics and _SHOULD_ be
   * avoided if possible.
   */
   ...
   * map is a [Callback
   * Object](https://spec.openapis.org/oas/latest.html#callback-object) that
   ...
   * overrides any declared top-level
   * [`security`](https://spec.openapis.org/oas/latest.html#oasSecurity). To
