 ...
 * [Security
 * Schemes](https://spec.openapis.org/oas/latest.html#componentsSecuritySchemes)
 * under the [Components
 * Object](https://spec.openapis.org/oas/latest.html#components-object).
 *
 ...
 * Object](https://spec.openapis.org/oas/latest.html#openapi-object) or
 * [Operation
 * Object](https://spec.openapis.org/oas/latest.html#operation-object), only one
 * of the Security Requirement Objects in the list needs to be satisfied to
...
export interface SecurityRequirementObject {
   ...
   * Schemes](https://spec.openapis.org/oas/latest.html#componentsSecuritySchemes)
   * under the [Components
   * Object](https://spec.openapis.org/oas/latest.html#components-object). If
   * the security scheme is of type `"oauth2"` or `"openIdConnect"`, then the
