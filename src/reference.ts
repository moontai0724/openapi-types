 ...
 * \[[RFC3986](https://spec.openapis.org/oas/latest.html#bib-RFC3986)\], which
 ...
 * Objects`](https://spec.openapis.org/oas/latest.html#schema-object) that
...
export interface ReferenceObject {
   ...
   * component. [CommonMark syntax](https://spec.commonmark.org/) _MAY_ be used
   * for rich text representation. If the referenced object-type does not allow
