...
export interface ServerVariableObject extends Extendable {
   ...
   * from a limited set. The array _MUST NOT_ be empty.
   */
  enum?: string[];
  /**
   * The default value to use for substitution, which _SHALL_ be sent if an
   * alternate value is _not_ supplied. Note this behavior is different than the
   * [Schema Object’s](https://spec.openapis.org/oas/latest.html#schema-object)
   * treatment of default values, because in those cases parameter values are
   * optional. If the
   * [`enum`](https://spec.openapis.org/oas/latest.html#serverVariableEnum) is
