 ...
 * document](https://spec.openapis.org/oas/latest.html#openapi-document).
 *
...
interface BaseOpenAPIObject extends Extendable {
   ...
   * number](https://spec.openapis.org/oas/latest.html#versions) of the OpenAPI
   * Specification that the OpenAPI document uses. The `openapi` field _SHOULD_
   * be used by tooling to interpret the OpenAPI document. This is _not_ related
   * to the API
   * [`info.version`](https://spec.openapis.org/oas/latest.html#infoVersion)
   * string.
   */
  openapi: string;
  /**
   ...
   * Objects](https://spec.openapis.org/oas/latest.html#schema-object) contained
   ...
   * Object](https://spec.openapis.org/oas/latest.html#server-object) with a
   * [url](https://spec.openapis.org/oas/latest.html#serverUrl) value of `/`.
   */
   ...
   * all tags that are used by the [Operation
   * Object](https://spec.openapis.org/oas/latest.html#operation-object) must be
 ...
 * elements of an API. The OpenAPI document _MUST_ contain at least one
 * [paths](https://spec.openapis.org/oas/latest.html#paths-object) field, a
 * [components](https://spec.openapis.org/oas/latest.html#oasComponents) field
 * or a [webhooks](https://spec.openapis.org/oas/latest.html#oasWebhooks) field.
