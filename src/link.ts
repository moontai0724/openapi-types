 ...
 * expression](https://spec.openapis.org/oas/latest.html#runtime-expressions) is
 * used for accessing values in an operation and using them as parameters while
...
export interface LinkObject extends Extendable {
   ...
   * [Operation
   * Object](https://spec.openapis.org/oas/latest.html#operation-object).
   * Relative `operationRef` values _MAY_ be used to locate an existing
   * [Operation
   * Object](https://spec.openapis.org/oas/latest.html#operation-object) in the
