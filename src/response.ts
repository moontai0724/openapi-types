...
export interface ResponseObject extends Extendable {
  /**
   * A description of the response. [CommonMark syntax](https://spec.commonmark.org/) _MAY_ be used for rich text representation.
   */
  description: string;
  /**
   * Maps a header name to its definition. \[[RFC7230](https://spec.openapis.org/oas/latest.html#bib-RFC7230)\] states header names are case insensitive. If a response header is defined with the name `"Content-Type"`, it _SHALL_ be ignored.
   */
